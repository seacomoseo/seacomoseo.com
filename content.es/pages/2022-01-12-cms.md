...
- La opción compleja es directamente en el repositorio de [icon-github Github](https://github.com/) o [icon-gitlab Gitlab](https://gitlab.com/) (bastante intuitivo navegar y editar archivos; **datos de acceso** mencionados en [entrega](/entrega/)):
